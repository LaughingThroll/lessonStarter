...
const teamSection = (currentDate, allDaysInMonth, teams) => {
  return (teams.map((team) => ` <tr class="team-body calendar-table--indentation ${team.name === "Frontend Team" ? "melrose-theme melrose-theme--background" : team.name === "Backend Team" ? "malibu-theme malibu-theme--background" : ''}" >
