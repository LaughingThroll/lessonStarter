...
class Bar {
  constructor(appElement, currentDate, previousMonth, nextMonth) {
    this.appElement = appElement;
    this.currentDate = currentDate;
    this.prevMonth = previousMonth;
  ...
  render() {
    ...
    const bar = `<div class="month-navigate">
      ...
      <div class="month-navigate__text">${this.currentDate.toLocaleString("en-US", {
        month: "long",
        year: "numeric",
      })}</div>
